...
#define DW_SCK1_Pin GPIO_PIN_12
#define DW_SCK1_GPIO_Port GPIOE
#define DW_MISO1_Pin GPIO_PIN_13
#define DW_MISO1_GPIO_Port GPIOE
#define DW_MOSI1_Pin GPIO_PIN_14
#define DW_MOSI1_GPIO_Port GPIOE
